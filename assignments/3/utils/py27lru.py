...
def lru_cache(maxsize=255, timeout=None):
    ...
    class _LRU_Cache_class(object):
        def __init__(self, input_func, max_size, timeout):
            ...
            # caller2 : [OrderedDict2, last_refresh_time2]}. In case of an instance method - the caller is the
            # instance, in case called from a regular function - the caller is None.
            self._caches_dict = {}
        ...
        def _cache_wrapper(self, caller, *args, **kwargs):
            ...
            cur_caller_cache_dict[key] = self._input_func(caller, *args, **kwargs) if caller is not None else \
